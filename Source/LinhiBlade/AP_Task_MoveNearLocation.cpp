...
UAP_Task_MoveNearLocation * UAP_Task_MoveNearLocation::MoveNearLocation(UGameplayAbility * OwningAbility, FName TaskInstanceName, FVector Location, float Range)
{
	...
	UE_LOG(LogTemp, Warning, TEXT("UAP_Task_MoveNearLocation::MoveNearLocation() %s"), *MyObj->TargetLocation.ToCompactString());
	return MyObj;
}

UAP_Task_MoveNearLocation * UAP_Task_MoveNearLocation::MoveNearLocationTarget(UGameplayAbility * OwningAbility, FName TaskInstanceName, FGameplayAbilityTargetDataHandle TargetHandle, float Range)
{
	// receive call from blueprint
	UAP_Task_MoveNearLocation* MyObj = NewAbilityTask<UAP_Task_MoveNearLocation>(OwningAbility, TaskInstanceName);
	...
	MyObj->AcceptanceRadius = Range;
	UE_LOG(LogTemp, Warning, TEXT("UAP_Task_MoveNearLocation::MoveNearTarget() %s"), *MyObj->TargetLocation.ToCompactString());
	return MyObj;
}
