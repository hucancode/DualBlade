...
public:
	UFUNCTION(BlueprintCallable, Category = "Ability|Tasks", meta = (HidePin = "OwningAbility", DefaultToSelf = "OwningAbility", BlueprintInternalUseOnly = "TRUE"))
		static UAP_Task_LookAtLocation* LookAtLocation(UGameplayAbility* OwningAbility, FName TaskInstanceName, 
			FVector Location);
	UFUNCTION(BlueprintCallable, Category = "Ability|Tasks", meta = (HidePin = "OwningAbility", DefaultToSelf = "OwningAbility", BlueprintInternalUseOnly = "TRUE"))
		static UAP_Task_LookAtLocation* LookAtLocationTarget(UGameplayAbility* OwningAbility, FName TaskInstanceName,
