...
#include "AP_TargetActor_CircleAOE.h"
...
// --------------------------------------------------------------------------------------------------------------------------------------------------------
//
//	AAP_TargetActor_CircleAOE
//
// --------------------------------------------------------------------------------------------------------------------------------------------------------

AAP_TargetActor_CircleAOE::AAP_TargetActor_CircleAOE(const FObjectInitializer& ObjectInitializer)
...
void AAP_TargetActor_CircleAOE::StartTargeting(UGameplayAbility* InAbility)
{
	Super::StartTargeting(InAbility);
	SourceActor = InAbility->GetCurrentActorInfo()->AvatarActor.Get();
}

void AAP_TargetActor_CircleAOE::ConfirmTargetingAndContinue()
{
...
FGameplayAbilityTargetDataHandle AAP_TargetActor_CircleAOE::MakeTargetData(const TArray<TWeakObjectPtr<AActor>>& Actors, const FVector& Origin) const
{
	if (OwningAbility)
	{
...
TArray<TWeakObjectPtr<AActor> >	AAP_TargetActor_CircleAOE::PerformOverlap(const FVector& Origin)
{
